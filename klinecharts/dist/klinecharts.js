...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.klinecharts = factory());
...
function logTag() {
  {
    console.log('%c❤️ Welcome to klinecharts. Version is 8.6.2', 'border-radius:2px;border:dashed 1px #2196F3;padding:26px 20px;font-size:14px;color:#2196F3');
  }
}
...
function getTechnicalIndicatorPlotStyle(kLineDataList, techDataList, dataIndex, plot, techStyles, defaultStyle) {
  ...
  var isDashed = defaultStyle.isDashed;
  var cbData = {
    prev: {
...
var TechnicalIndicator = /*#__PURE__*/function () {
  function TechnicalIndicator(_ref) {
    ...
    this.styles = styles; // 扩展数据

    this.extendData = extendData; // 结果
  ...
  _createClass(TechnicalIndicator, [{
    ...
    key: "setExtendData",
    value: function setExtendData(extendData) {
  ...
  _createClass(TechnicalIndicatorStore, [{
    ...
    value: function override(techOverride, paneId) {
      ...
      var name = techOverride.name,
          ...
          extendData = techOverride.extendData;
      ...
      instances.forEach(function (paneInstances) {
        if (paneInstances.has(name)) {
          ...
          var extendDataSuccess = tech.setExtendData(extendData);
...
var Shape = /*#__PURE__*/function (_Overlay) {
  ...
  _createClass(Shape, [{
    ...
    value: function _drawText(ctx, texts, styles, defaultStyles) {
      ...
      ctx.font = createFont(styles.size || defaultStyles.size, styles.weight || defaultStyles.weight, styles.family || defaultStyles.family);
...
var ShapeStore = /*#__PURE__*/function () {
  ...
  _createClass(ShapeStore, [{
    ...
    value: function setInstanceOptions() {
      ...
      var apply = function apply(instance) {
  ...
  _createClass(AnnotationStore, [{
    ...
    value: function add(annotations, paneId) {
      ...
      annotations.forEach(function (annotation) {
        var timestampAnnotations = _this2._annotations.get(paneId);

        var timestamp = annotation.points().timestamp;
...
var TechnicalIndicatorView = /*#__PURE__*/function (_View) {
  ...
  _createClass(TechnicalIndicatorView, [{
    ...
    value: function _drawTechs() {
      ...
      var to = this._chartStore.timeScaleStore().to();
      ...
      techs.forEach(function (tech) {
        ...
        _this3._drawGraphics(function (x, i, kLineData, halfBarSpace, barSpace) {
          ...
          if (tech.shouldOhlc && !isCandleYAxis) {
            _this3._drawCandleBar(x, halfBarSpace, barSpace, kLineData, styles.bar, CandleType.OHLC);
          }
          ...
          plots.forEach(function (plot) {
            ...
            switch (plot.type) {
              ...
              case TechnicalIndicatorPlotType.LINE:
                {
                  var _plotStyle2 = null;

                  if (isValid(value)) {
                    _plotStyle2 = getTechnicalIndicatorPlotStyle(dataList, techResult, i, plot, styles, {
                    ...
                    var prePlotStyle = linePlotStyles[lineCount];
                    ...
                    if (prePlotStyle) {
                      if (prePlotStyle.color !== _plotStyle2.color) {
                        lines.push({
                          color: prePlotStyle.color,
                          isDashed: prePlotStyle.isDashed,
                          coordinates: lineCoordinates[lineCount]
                        });
                        lineCoordinates[lineCount] = [coordinate];
                      } else {
                        if (prePlotStyle.isDashed !== _plotStyle2.isDashed) {
                          lines.push({
                            color: prePlotStyle.color,
                            isDashed: prePlotStyle.isDashed,
                            coordinates: lineCoordinates[lineCount]
                    ...
                    if (i === to - 1) {
                      lines.push({
                        ...
                        isDashed: _plotStyle2.isDashed,
                        coordinates: lineCoordinates[lineCount]
                      });
                    }
                  }

                  linePlotStyles[lineCount] = _plotStyle2;
                  lineCount++;
                  break;
                }
            }
    ...
    value: function _drawLines(lines, techOptions) {
      ...
      lines.forEach(function (line) {
        ...
        if (line.isDashed) {
          _this4._ctx.setLineDash(techOptions.line.dashValue);
        } else {
          _this4._ctx.setLineDash([]);
        }
    ...
    key: "_drawCandleBar",
    value: function _drawCandleBar(x, halfBarSpace, barSpace, kLineData, barOptions, barStyle) {
      var open = kLineData.open,
      ...
      var priceY = [openY, closeY, this._yAxis.convertToPixel(high), this._yAxis.convertToPixel(low)];
...
var TechnicalIndicatorOverlayView = /*#__PURE__*/function (_View) {
  ...
  _createClass(TechnicalIndicatorOverlayView, [{
    ...
    value: function _drawBatchTechToolTip(crosshair, techs, techOptions) {
      ...
      var startTop = top;
      techs.forEach(function (tech) {
        top += techTooltipOptions.text.marginTop + _this5._drawTechTooltip(crosshair, tech, techOptions, top) + techTooltipOptions.text.marginBottom;
      });
      return top - startTop;
    }
    /**
    ...
    value: function _drawTechTooltip(crosshair, tech, techOptions) {
      ...
      tooltipData.values.forEach(function (v) {
        ...
        if (labelX + textWidth > _this6._width) {
          labelX = textMarginLeft;
...
var Axis = /*#__PURE__*/function () {
  ...
  _createClass(Axis, [{
    ...
    value: function _computeTicks() {
      ...
      if (this._range >= 0) {
        var intervalPrecision = this._computeInterval(this._realRange);

        var interval = intervalPrecision.interval;
        var precision = intervalPrecision.precision;
        var first = round(Math.ceil(this._realMinValue / interval) * interval, precision);
        var last = round(Math.floor(this._realMaxValue / interval) * interval, precision);
        var n = 0;
        var f = first;
...
var YAxis = /*#__PURE__*/function (_Axis) {
  ...
  _createClass(YAxis, [{
    ...
    value: function _optimalTicks(ticks) {
      ...
      ticks.forEach(function (_ref4) {
        ...
        switch (yAxisType) {
          ...
          case YAxisType.LOG:
            {
              y = _this3._innerConvertToPixel(log10(v));
        ...
        if (y > textHeight && y < _this3._height - textHeight && (validY && Math.abs(validY - y) > textHeight * 2 || !validY)) {
          optimalTicks.push({
            v: value,
            y: y
          });
    ...
    value: function _innerConvertToPixel(value) {
      var rate = (value - this._minValue) / this._range;
    ...
    value: function convertFromPixel(pixel) {
      var rate = this.isReverse() ? pixel / this._height : 1 - pixel / this._height;
      var value = rate * this._range + this._minValue;
...
var TechnicalIndicatorPane = /*#__PURE__*/function (_Pane) {
  ...
  _createClass(TechnicalIndicatorPane, [{
    ...
    key: "_initHeight",
    value: function _initHeight(props) {
  ...
  _createClass(CandleView, [{
    ...
    value: function _drawCandle(candleOptions) {
      ...
      this._drawGraphics(function (x, i, kLineData, halfBarSpace, barSpace) {
        _this2._drawCandleBar(x, halfBarSpace, barSpace, kLineData, candleOptions.bar, candleOptions.type);
      });
    }
    /**
     * 渲染最高最低价格
    ...
    key: "_drawHighLowPrice",
    value: function _drawHighLowPrice(priceMarkOptions) {
      ...
      visibleDataList.forEach(function (_ref2) {
        var index = _ref2.index,
            data = _ref2.data;
        var high = formatValue(data, 'high', Number.MIN_SAFE_INTEGER);
        ...
        var low = formatValue(data, 'low', Number.MAX_SAFE_INTEGER);
      ...
      var highY = this._yAxis.convertToPixel(highest.price);

      highest.y = highY;

      var lowY = this._yAxis.convertToPixel(lowest.price);
    ...
    key: "_drawRealHighLowPrice",
    value: function _drawRealHighLowPrice(options, offset, precision, data) {
      if (!options.show) {
        return;
      }
      ...
      var text = formatPrecision(price, precision);
  ...
  _createClass(CandleOverlayView, [{
    ...
    value: function _drawTooltip(crosshair, techs) {
      ...
      if (candleTooltipOptions.showType === TooltipShowType.RECT && techTooltipOptions.showType === TooltipShowType.RECT) {
        this._drawCandleTooltipWithRect(crosshair, techs, candleOptions, isDrawCandleTooltip, techOptions, 0, isDrawTechTooltip);
      } else {
        if (candleTooltipOptions.showType === TooltipShowType.STANDARD) {
          var tooltipHeight = this._drawCandleTooltipWithStandard(crosshair.kLineData, candleOptions, isDrawCandleTooltip);

          if (techTooltipOptions.showType === TooltipShowType.STANDARD) {
            var offsetTop = isDrawCandleTooltip ? tooltipHeight + candleTooltipOptions.text.marginTop : 0;

            this._drawBatchTechToolTip(crosshair, techs, techOptions, offsetTop, isDrawTechTooltip);
          } else {
            this._drawCandleTooltipWithRect(crosshair, techs, candleOptions, false, techOptions, tooltipHeight, isDrawTechTooltip);
          }
        } else {
          var _tooltipHeight = this._drawBatchTechToolTip(crosshair, techs, techOptions, 0, isDrawTechTooltip);

          this._drawCandleTooltipWithRect(crosshair, techs, candleOptions, isDrawCandleTooltip, techOptions, _tooltipHeight, false);
        }
      }
    }
    /**
    ...
    value: function _drawCandleTooltipWithStandard(kLineData, candleOptions, isDrawCandleTooltip) {
      ...
      labels.forEach(function (label, i) {
        ...
        if (labelX + labelWidth + textWidth > _this._width) {
          labelX = textMarginLeft;
          tooltipHeight += textSize + 1;
          labelY += textSize + 1;
        }
        ...
        renderText(_this._ctx, valueColor, labelX + labelWidth, labelY, valueText);
    ...
    value: function _drawCandleTooltipWithRect(crosshair, techs, candleOptions, isDrawCandleTooltip, techOptions, offsetTop, isDrawTechTooltip) {
      var _this2 = this;
      ...
      var rectY = offsetTop + rectOptions.offsetTop;
...
var ID = /*#__PURE__*/function () {
  ...
  _createClass(ID, [{
    ...
    value: function next() {
      ...
      return "".concat(prefix).concat(timestamp, "_").concat(this._baseId);
    }
  }]);
...
var ZoomScrollEventHandler = /*#__PURE__*/function (_EventHandler) {
  ...
  function ZoomScrollEventHandler(chartStore) {
    ...
    _this = _super.call(this, chartStore); // 惯性滚动开始时间

    _this._flingStartTime = null; // 惯性滚动定时器

    _this._flingScrollTimerId = null; // 开始滚动时坐标点
    ...
    value: function mouseLeaveEvent(event) {
      ...
      if (isTouch(event)) {
        if (this._startScrollCoordinate) {
          ...
          var v = distance / (time > 0 ? time : 1) * 20;

          if (time < 200 && Math.abs(v) > 0) {
            var flingScroll = function flingScroll() {
              _this2._flingScrollTimerId = requestAnimationFrame(function () {
                _this2._chartStore.timeScaleStore().startScroll();

                _this2._chartStore.timeScaleStore().scroll(v);

                v = v * (1 - 0.025);

                if (Math.abs(v) < 1) {
                  if (_this2._flingScrollTimerId) {
                    cancelAnimationFrame(_this2._flingScrollTimerId);
                    _this2._flingScrollTimerId = null;
                  }
                } else {
                  flingScroll();
                }
...
var Annotation = /*#__PURE__*/function (_Overlay) {
  ...
  function Annotation(_ref) {
    ...
    var id = _ref.id,
        ...
        point = _ref$point === void 0 ? {} : _ref$point,
        chartStore = _ref.chartStore,
        xAxis = _ref.xAxis,
        yAxis = _ref.yAxis,
        styles = _ref.styles;
...
var DEFAULT_TECH_PANE_HEIGHT = 100; // 技术指标窗口id前缀

var TECH_PANE_ID_PREFIX = 'tech_pane_'; // 图形id前缀

var SHAPE_ID_PREFIX = 'shape_'; // 注解id前缀

var ANNOTATION_ID_PREFIX = 'an_'; // 蜡烛图窗口id
...
var ChartPane = /*#__PURE__*/function () {
  ...
  _createClass(ChartPane, [{
    ...
    value: function _separatorDrag(dragDistance, topPaneId, bottomPaneId) {
      var topPane = this._panes.get(topPaneId);

      var bottomPane = this._panes.get(bottomPaneId);

      var topPaneMinHeight = topPane.minHeight();
      var bottomPaneMinHeight = bottomPane.minHeight();
    ...
    value: function _measurePaneHeight() {
      ...
      this._panes.forEach(function (pane) {
        if (pane.id() !== CANDLE_PANE_ID) {
          ...
          var paneMinHeight = pane.minHeight();

          if (_paneHeight < paneMinHeight) {
            _paneHeight = paneMinHeight;
          }

          if (techPaneTotalHeight + _paneHeight > paneExcludeXAxisSeparatorHeight) {
            techPaneTotalHeight = paneExcludeXAxisSeparatorHeight;
            _paneHeight = paneExcludeXAxisSeparatorHeight - techPaneTotalHeight;
            if (_paneHeight < 0) _paneHeight = 0;
          } else {
    ...
    value: function createTechnicalIndicator(tech, isStack) {
      ...
      var id = options.id || createId(TECH_PANE_ID_PREFIX);
    ...
    value: function createShape(ShapeTemplateClass, shapeOptions, paneId) {
      ...
      var shapeId = id || createId(SHAPE_ID_PREFIX);
      ...
      if (options.id !== CANDLE_PANE_ID) {
        ...
        if (pane) {
          ...
          if (isNumber(options.height) && options.height > 0) {
            var minHeight = pane.minHeight();
            var height = options.height < pane.minHeight ? minHeight : options.height;
...
var Chart = /*#__PURE__*/function () {
  ...
  _createClass(Chart, [{
    ...
    value: function scrollToRealTime(animationDuration) {
      ...
      var difBarCount = this._chartPane.chartStore().timeScaleStore().offsetRightBarCount() - this._chartPane.chartStore().timeScaleStore().offsetRightSpace() / dataSpace;
      var distance = difBarCount * dataSpace;
    ...
    value: function scrollToDataIndex(dataIndex, animationDuration) {
      ...
      var distance = (this._chartPane.chartStore().timeScaleStore().offsetRightBarCount() + (this.getDataList().length - 1 - dataIndex)) * this._chartPane.chartStore().timeScaleStore().dataSpace();
    ...
    key: "scrollToTimestamp",
    value: function scrollToTimestamp(timestamp, animationDuration) {
      if (!isNumber(timestamp)) {
    ...
    key: "zoomAtTimestamp",
    value: function zoomAtTimestamp(scale, timestamp, animationDuration) {
      if (!isNumber(scale)) {
 ...
 * limitations under the License.
 */
klinecharts.extension.addShapeTemplate([horizontalRayLine, horizontalSegment, horizontalStraightLine, verticalRayLine, verticalSegment, verticalStraightLine, rayLine, segment, straightLine, parallelStraightLine, priceChannelLine, priceLine, fibonacciLine]);
